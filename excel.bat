...
:Server1Available
MOVE %VAR2% \\10.140.95.101\c$\XeroxScan\OCR\%VAR3%.xlsx
MOVE C:\Umango\SCAN\HOTFOLDER\EXCEL\%VAR3%.xst \\10.140.95.101\c$\XeroxScan\OCR\
goto :EOF

REM Serwer 2 dostępny
:Server2Available
MOVE %VAR2% \\10.140.95.102\c$\XeroxScan\OCR\%VAR3%.xlsx
MOVE C:\Umango\SCAN\HOTFOLDER\EXCEL\%VAR3%.xst \\10.140.95.102\c$\XeroxScan\OCR\
goto :EOF